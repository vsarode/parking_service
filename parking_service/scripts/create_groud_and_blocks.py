...
b1, i = ParkingBlock.objects.get_or_create(block_code="B0", parking=g)
b2, i = ParkingBlock.objects.get_or_create(block_code="B1", parking=g)
b3, j = ParkingBlock.objects.get_or_create(block_code="B2", parking=g)
b4, j = ParkingBlock.objects.get_or_create(block_code="B3", parking=g)
